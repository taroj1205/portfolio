...
export default function Home() {
  ...
  return (
    <div className='py-6 flex flex-col items-center justify-center min-h-full'>
      <div className="max-w-5xl w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center pt-8">
