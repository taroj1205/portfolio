            ...
            <div className="px-8 py-6">
                ...
                {prevPost || nextPost ? (
                    <div className="mt-4 flex justify-between">
                        {prevPost ? (
                            <Link href={`/posts/${prevPost.slug}`} className="inline-block py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded">
                        ...
                        {nextPost && (
                            <Link href={`/posts/${nextPost.slug}`} className="inline-block py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded">
                        ...
                        <div className='mt-4'>
                            <Link href='/posts' className="inline-block py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded">
