...
export function useThemeOptions(): readonly ThemeOption[] {
    const t = useTranslations();
    
    return [
        { value: 'dark', label: t('theme.dark').toString(), color: '#333' },
        { value: 'light', label: t('theme.light').toString(), color: '#f4f4f4' },
    ];
}
