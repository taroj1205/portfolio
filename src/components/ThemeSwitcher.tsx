                        ...
                        resolvedTheme === "dark" ? (
                            ...
                            <div className="text-gray-500 w-6 h-6">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12 2C6.486 2 2 6.486 2 12C2 17.514 6.486 22 12 22C17.514 22 22 17.514 22 12C22 6.486 17.514 2 12 2ZM12 20C7.582 20 4 16.418 4 12C4 7.582 7.582 4 12 4C16.418 4 20 7.582 20 12C20 16.418 16.418 20 12 20Z" fill="currentColor" />
                                    <path d="M12 6C10.897 6 10 6.897 10 8V12H14V8C14 6.897 13.103 6 12 6Z" fill="currentColor" />
                                    <path d="M12 18C13.103 18 14 17.103 14 16V12H10V16C10 17.103 10.897 18 12 18Z" fill="currentColor" />
                                </svg>
                            </div>
                        )
                    ) : (
            ...
            {isOpen && (
                <div className="popup origin-top-right absolute right-0 mt-2 w-32 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                        ...
                        <button
                            className={`block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100 w-full text-left ${theme === "dark" ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                            role="menuitem"
                            onClick={() => {
                                setTheme("dark");
                                setIsOpen(false);
                        ...
                        <button
                            className={`block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100 w-full text-left ${theme === "system" ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                            role="menuitem"
                            onClick={() => {
                                setTheme("system");
                                setIsOpen(false);
